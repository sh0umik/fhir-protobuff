...
func (*PatientData) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func (*MaritalStatus) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{1} }
...
func init() { proto.RegisterFile("patient.proto", fileDescriptor14) }
